                ...
                <tr>
                    ...
                    <td>
                        @if($seminar->gambar_seminar)
                            <img src="{{ asset('storage/seminar_images/' . $seminar->gambar_seminar) }}" alt="Gambar Seminar" class="img-thumbnail" style="width: 100px; height: auto;">
                        @else
                            Tidak ada gambar
                        @endif
                    </td>
                    <td>
                        ...
                        <a href="{{ route('seminars.edit', $seminar->id) }}" class="btn btn-primary">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
