...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> <link
  ...
  rel="stylesheet"> <title>Seminarku - Daftar Seminar mudah</title> <!-- Bootstrap core CSS -->
<link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet"> <!-- Additional CSS Files --> <link
  rel="stylesheet" href="assets/css/fontawesome.css"> <link rel="stylesheet" href="assets/css/templatemo-scholar.css">
<link rel="stylesheet" href="assets/css/owl.css"> <link rel="stylesheet" href="assets/css/animate.css"> <link
...
<!-- ***** Preloader Start ***** -->
  ...
  <!-- ***** Header Area Start ***** -->
<header class="header-area header-sticky"> <div class="container"> <div class="row">
  <div class="col-12">
  <nav class="main-nav">
  <!-- ***** Logo Start ***** -->
  ...
  <div class="search-input">
    <form id="search" action="#">
      <input type="text" placeholder="Cari disini..." id='searchText' name="searchKeyword" onkeypress="handle" />
  ...
  <ul class="nav">
    ...
    <li class="scroll-to-section"><a href="#courses">Seminar</a></li>
        ...
        <div class="owl-carousel owl-banner">
          <div class="item item-1">
            <div class="header-text">
              <span class="category">Seminar Kamu</span>
              <h2>Temukan Daftar Seminar Dengan Lebih Mudah</h2>
              <p>Seminarku adalah website pencarian daftar seminar yang memudahkan Anda menemukan seminar sesuai
                kebutuhan.</p>
              <div class="buttons">
                ...
                <div class="icon-button">
                  <a href="#"><i class="fa fa-play"></i> Apa itu Seminar?</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="service-item">
          ...
          <div class="main-content">
            <h4>Pendaftaran Seminar Mudah</h4>
            <p>Daftar seminar dengan mudah dan cepat melalui platform kami.</p>
            <div class="main-button">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="service-item">
          ...
          <div class="main-content">
            <h4>Materi <br>Up to Date</h4>
            <p>Nikmati materi seminar terbaru yang selalu diperbarui sesuai tren terkini.</p>
            <div class="main-button">
              <a href="#">Selengkapnya</a>
            </div>
          </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="service-item">
          ...
          <div class="main-content">
            <h4>Pembicara <br>Expert</h4>
            <p>Dapatkan ilmu dari para pembicara yang ahli dan berpengalaman di bidangnya.</p>
            <div class="main-button">
              <a href="#">Selengkapnya</a>
            </div>
          </div>
    ...
    <div class="row">
        ...
        <div class="accordion" id="accordionExample">
          <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
              ...
              <div class="accordion-body">
                Mulailah dengan mencari seminar yang sesuai dengan minat Anda. Kami menyediakan berbagai topik seminar
          ...
          <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Kami bekerja sama dengan berbagai ahli dan profesional untuk menghadirkan seminar berkualitas. Anda
                dapat berpartisipasi dalam seminar dan berbagi pengalaman dengan peserta lain.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Kami menyediakan berbagai topik seminar dengan pembicara yang berpengalaman dan ahli di bidangnya,
                memastikan Anda mendapatkan ilmu yang bermanfaat dan up-to-date.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingFour">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                ...
                Apakah kami mendapatkan dukungan terbaik?
              </button>
            </h2>
            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Ya, kami menyediakan dukungan terbaik untuk semua peserta seminar. Anda bisa menghubungi tim kami kapan
                saja untuk bantuan dan informasi lebih lanjut.
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-5 align-self-center">
        <div class="section-heading">
          <h6>Tentang Kami</h6>
          <h2>Apa yang membuat kami menjadi akademi seminar online terbaik?</h2>
          <p>Seminarku adalah platform yang menyediakan berbagai seminar dengan topik terkini dan pembicara ahli. Kami
            bertujuan untuk memudahkan Anda dalam menemukan dan mengikuti seminar yang sesuai dengan kebutuhan Anda.</p>
          <div class="main-button">
            <a href="#">Selengkapnya</a>
          </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="section-heading">
                        <h6>Seminar Terdekat</h6>
                        <h2>Seminar Terdekat</h2>
                    </div>
                </div>
            </div>
...
<div class="row event_box">
            ...
            <div class="main-button text-right m-2">
              <a href="#" onclick="checkLogin(event)">Daftar</a>
            </div>
          </div>
                    </div>
                </div>
...
<script>
  function checkLogin(event) {
    event.preventDefault(); // Mencegah tautan mengikuti href

    // Cek apakah pengguna sudah login (misalnya menggunakan Laravel Blade directive)
    @if (Auth:: guest())
    Swal.fire({
      icon: 'warning',
      title: 'Maaf',
      text: 'Anda harus login terlebih dahulu untuk mendaftar seminar ini',
