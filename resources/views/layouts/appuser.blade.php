        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                      <li class="scroll-to-section"><a href="{{ route('homeuser')}}">Beranda</a></li>
                      <li class="scroll-to-section"><a href="{{ route('homeuser')}}">Fitur</a></li>
                      <li class="scroll-to-section"><a href="{{ route('homeuser')}}"  class="active">Seminar</a></li>
